...
$$
    ...
    BEGIN
        ...
        values ('Шапка крутая пиратская', 'Шапка крутая пиратская шапка', 150.00, 'hat.png', 'hat', 50, 90, 250, 100),
               ...
               ('Кофта зеленая', 'Кофта зеленая', 150.00, 'hoodie_green.png', 'shirt', 50, 282, 174, 100),
               ('Кофта красная', 'Кофта красная', 150.00, 'hoodie_red.png', 'shirt', 50, 282, 174, 100),
               ('Рубашка', 'Рубашка', 150.00, 'shirt_white.png', 'shirt', 50, 282, 174, 100),
               ('Шарф красный', 'Шарф красный', 150.00, 'scarf_red.png', 'accessories', 50, 270, 134, 110),
               ('Шарф зеленый', 'Шарф зеленый', 150.00, 'scarf_green.png', 'accessories', 50, 270, 134, 110);
